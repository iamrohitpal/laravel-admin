...
class AdminController extends Controller
{
    ...
    public function __construct(string $type = 'Dashboard')
    {
        $this->list = Permission::getPermissionBySlugAndId($type);
        $this->create = Permission::getPermissionBySlugAndId($type, 'Create');
        $this->edit = Permission::getPermissionBySlugAndId($type, 'Edit');
        $this->delete = Permission::getPermissionBySlugAndId($type, 'Delete');
    }
